    ...
    <AppShell navItems={navItems}>
      ...
      {profile ? (
        <section className="mt-5 space-y-3">
          ...
          <Link className="app-card flex min-h-16 items-center justify-between p-3.5" to="/ciudadano/configuracion"><span className="flex items-center gap-3"><span className="grid h-10 w-10 place-items-center rounded-lg bg-emergency-50 text-emergency-600"><Settings2 className="h-5 w-5" /></span><span><strong className="block text-sm text-ink">Configuracion</strong><span className="mt-0.5 block text-[11px] text-muted">Preferencias de la aplicacion</span></span></span><span className="text-emergency-600">›</span></Link>
